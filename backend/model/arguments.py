...
data_arg.add_argument('--infer_trials', type=int, default=1,
                      help='# of test 1-shot trials')
data_arg.add_argument('--way', type=int, default=4,
                      help='Ways in the 1-shot trials')
data_arg.add_argument('--infer_way', type=int, default=300,
                      help='Ways in the 1-shot trials')
...
misc_arg.add_argument('--data_dir', type=str, default='./data/our_processed/',
